...
let oldCupboards = house.get("Cupboards");
house.set("Cupboards", 10);
value = house.get("Cupboards");
console.log("The number of Cupboards have been updated from: " + oldCupboards + " to: " + value);